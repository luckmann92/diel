        ...
        <div class="page-filter__right">
            ...
            <div class="filter__diel-select diel-select">
                ...
                <select class="filter__diel-js" hidden>
                    ...
                    <option class="filter__diel-option-js" value="<?=$APPLICATION->GetCurPageParam('list_num=48', array('list_num'))?>#catalog-sort-panel" <?if($_GET["list_num"] == "48"):?> selected <?endif;?>>48</option>
