                ...
                <div class="all-collections-item__inner">
                    ...
                    <? if ($arItem['PREVIEW_PICTURE']) { ?>
                        <a class="all-collections-item__image-wrapper" href="<?= $arItem['DETAIL_PAGE_URL'] ?>">
                            <div class="all-collections-item__image">
                                <div class="all-collections-item__label-year label-year <?= $k % 2 == 0 ? '' : 'all-collections-item__label-year-left' ?>">
                                    <?= $arItem['PROPERTIES']['LABLE_YEAR']['VALUE'] ?>
                                </div>
